...
bool ticks_compare(const struct list_elem *t1, const struct list_elem *t2, void *aux UNUSED);
...
timer_sleep (int64_t ticks) 
{
  ...
  //while (timer_elapsed (start) < ticks) 
	...
	list_insert_ordered(&waiting_list, &t->elem, (list_less_func*) &ticks_compare, NULL);
	thread_block();
	intr_set_level(old_level);
}
